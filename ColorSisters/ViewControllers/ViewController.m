...
- (void)viewDidLoad
{
    ...
    self.pageTitles = @[@"Over 200 Tips and Tricks", @"Discover Hidden Features", @"Bookmark Favorite Tip", @"Free Regular Update"];
//    self.pageImages = @[@"product_images.bundle/Dior/100.png",
...
- (KokkoDetailedMatchViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    KokkoDetailedMatchViewController *pageContentViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"PageContentViewController2"];
